...
public class JenkinsExample {
    ...
    public static void main(String[] args) {
        ...
        // Jenkins url
        String jenkinsUrl = "https://jenkins.uw.edu.pl";

        // Build name
        String jobName = "probad-nightly";
        ...
        String getUrl = "https://adres.strony/job/probad-nightly/lastSuccessfulBuild/api/json";
        ...
        try {
            ...
            ByteStreams.copy(entity.getContent(), System.out);
